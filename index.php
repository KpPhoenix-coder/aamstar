   ...
   <main id="primary" class="site-main">
         ...
         <div class="swiper hero-slider">
            <div class="swiper-wrapper">
               <div class="swiper-slide tj-slider-item">
                  <div class="slider-content-area" style="background-image: url(assets/images/slider/slider01.jpg);" data-bg-image="assets/images/slider/slider01.jpg">
                     <div class="container">
                        <div class="row">
                           <div class="col-lg-9">
                     ...
                     <!-- <div class="hero-shapes2">
                        <img src="assets/images/shapes/price-4.png" alt="Shapes">
                     </div> -->
                  </div>
               </div>
               <div class="swiper-slide tj-slider-item">
                  <div class="slider-content-area" style="background-image: url(assets/images/slider/slider02.webp);" data-bg-image="assets/images/slider/slider02.webp">
                     <div class="container">
                        <div class="row">
                           <div class="col-lg-9">
                              <div class="slider-text">
               ...
               <div class="swiper-slide tj-slider-item">
                  <div class="slider-content-area" style="background-image: url(assets/images/slider/slider03.webp);" data-bg-image="assets/images/slider/slider03.webp">
                     <div class="container">
                        <div class="row">
                           <div class="col-lg-9">
                              <div class="slider-text">
            ...
            <div class="slider-navigation">
               <div class="slider-prev"><i class="icon_1 fa-light fa-arrow-left-long"></i></div>
               <div class="slider-next"><i class="icon_2 fa-light fa-arrow-right-long"></i></div>
            </div>
         </div>
      </section>
      <!-- end: Slider Area -->
      ...
      <section class="tj-about-section-two">
         ...
         <div class="about-shapes">
            <img src="assets/images/shapes/ab-shapes.png" alt="Shapes">
         </div>
      </section>
      <!-- end: About Area -->
      ...
      <section class="tj-faq-section">
         <div class="faq-wrapper">
            ...
            <div class="faq-imges">
               <img src="assets/images/project/faq-1.jpg" alt="Image">
            </div>
         </div>
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-6">
                  <div class="faq-content-inner">
                     <div class="tj-heading-area">
                        <span class="sub-title">// Ask Question //</span>
                        <h2 class="sec-title">Have any Question about.....</h2>
                     </div>
      ...
      <section class="tj-project-section-two">
         ...
         <div class="project-shapes">
            <img src="assets/images/shapes/project-shapes.png" alt="Shapes">
         </div>
      </section>
      <!-- end: Project Area -->
               ...
               <div class="col-12">
                  <div class="tj-heading-area">
                     <div class="heading-left">
                        <span class="sub-title">// Recent Blog Post //</span>
                        <h2 class="sec-title">Latest Articles And Updates</h2>
                     </div>
